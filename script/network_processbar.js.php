...
function setImageWidth(currentTime)
{
	...
	var totalTime = 7000;            //假定恢复出厂设置需要用到的时间，此处为10秒
	...
	{
		document.getElementById("showText").innerHTML = "<?php echo $PRO_NETWORK_TIP_A; ?>";
	...
	{
		document.getElementById("showText").innerHTML = "<?php echo $PRO_NETWORK_TIP_B; ?>：http://<?php echo $settings['IPADDR'] ?>";
