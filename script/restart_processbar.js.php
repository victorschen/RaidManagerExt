...
function setImageWidth(currentTime)
{
	...
	var totalTime = 110000;            //假定恢复出厂设置需要用到的时间，此处为10秒
	...
	{
		document.getElementById("showText").innerHTML = "<?php echo $RESTART_TIP_A; ?>";
	...
	{
		document.getElementById("showText").innerHTML = "<?php echo $RESTART_TIP_B; ?>";
