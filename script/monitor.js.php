...
function showDiskStatus(xmldoc)
{
	...
	var disksStatus = new Array(100);

	var debug = "";
	for(var i=0; i<diskNumber; i++)
	{
		var scsiId = diskArray.item(i).getAttribute("scsiID");
		disksStatus[parseInt(trim(scsiId))] = diskArray.item(i).getAttribute("status");
	}

	var rackDiskSum = (Math.ceil(diskNumber/16)) * 16;
	for(var i=0; i<rackDiskSum; i++)
	{
...
function showDiskInfo(xmldoc)
{
	...
	var disksStatus = new Array(100);		
	var preDiskNumber = (Math.ceil(diskNumber/16)) * 16;                                //设置盘数。此版本为16盘位的阵列		
	//alert(preDiskNumber + ',' + diskNumber);
	...
	{	
		...
		for(var m=0; m<diskNumber; m++)           //遍历实际存在的每一个磁盘，找寻与用户点击对应的那个磁盘
		{
			...
			if(j==diskID)  //找到用户点击的盘号拥有对应scsiID的磁盘
			{
				flag=0;
				var scsiId = parseInt(trim(diskArray.item(m).getAttribute("scsiID"))) + 1;
...
function showRackBody(xmldoc)
{
	var rackContent = new Array();
	var diskArray = xmldoc.getElementsByTagName('Disk');   //将XML中所有Disk节点装入数组
	var diskNumber = diskArray.length;                     //实际检测到的盘数
	var rackCount = Math.floor(diskNumber / 16);
	var offset = 0;
	//alert('diskNumber,rackCount' + diskNumber + ',' + rackCount);
	if(rackCount >= 0) {
		for(var i=0; i<=rackCount; i++) {
			offset = 16 * i;
			rackContent.push('<table width="656" height="182" border="0" cellpadding="0" cellspacing="0" background="images/bg.gif" bgcolor="#353535">');
			rackContent.push('  <tr> ');
			rackContent.push('    <td height="182" align="left"><table width="622" border="0">');
			rackContent.push('      <tr>');
			rackContent.push('        <td width="45">&nbsp;</td>');
			rackContent.push('        <td width="567"><table width="550" border="0" cellspacing="1" cellpadding="0">');
			rackContent.push('          <tr  style="cursor:pointer">');

			for(var j=offset; j<(offset+16); j++) {
				rackContent.push('            <td width="32" onclick=\"dispShowDisk(' +j+',event)\"><img id="'+j+'"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (1+offset) + ',event)\"><img id="1"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (2+offset) + ',event)\"><img id="2"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (3+offset) + ',event)\"><img id="3"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (4+offset) + ',event)\"><img id="4"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (5+offset) + ',event)\"><img id="5"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (6+offset) + ',event)\"><img id="6"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (7+offset) + ',event)\"><img id="7"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (8+offset) + ',event)\"><img id="8"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (9+offset) + ',event)\"><img id="9"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (10+offset) + ',event)\"><img id="10"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (11+offset) + ',event)\"><img id="11"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (12+offset) + ',event)\"><img id="12"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('            <td width="32" onclick=\"dispShowDisk(' + (13+offset) + ',event)\"><img id="13"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('			  <td width="32" onClick=\"dispShowDisk(' + (14+offset) + ',event)\"><img id="14"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
				//rackContent.push('  		  <td width="32" onClick=\"dispShowDisk(' + (15+offset) + ',event)\"><img id="15"  src="images/22.jpg" width="30" height="138" alt="<?php echo $MONITOR_DISPLAY_DISKDETAIL; ?>"></td>');
			}
			rackContent.push('  		  <!--下面这个td用来支撑表格宽度 -->');
			rackContent.push('  		  <td width="17" height="138"></td>                              ');
			rackContent.push('          </tr>');
			rackContent.push('        </table></td>');
			rackContent.push('      </tr>');
			rackContent.push('      ');
			rackContent.push('    </table></td>');
			rackContent.push('  </tr>');
			rackContent.push('  ');
			rackContent.push('  <tr> ');
			rackContent.push('    <td align="left" valign="top" bgcolor="#333333"><table width="641" height="35" border="0" cellpadding="0" cellspacing="0">');
			rackContent.push('      <tr>');
			rackContent.push('        <td width="44">&nbsp;</td>');
			rackContent.push('        <td width="597" align="left" valign="top"><table width="536" border="0" cellspacing="0" cellpadding="0">');
			rackContent.push('          <tr>');
			rackContent.push('            <td width="38" height="31" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx2.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx3.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx4.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx5.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx6.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx7.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx8.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx9.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx10.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><strong><font color="#FFFFFF"><img src="images/dx11.jpg" width="28" height="27"></font></strong></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx12.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td width="33" align="center" bgcolor="#333333"><img src="images/dx13.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx14.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('					<td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx15.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('					<td width="38" align="center"><table width="20" border="0" cellpadding="0" cellspacing="0" class="unnamed1">');
			rackContent.push('                <tr>');
			rackContent.push('                  <td align="center" bgcolor="#009900"><img src="images/dx16.jpg" width="28" height="27"></td>');
			rackContent.push('                </tr>');
			rackContent.push('            </table></td>');
			rackContent.push('            <!--  -->');
			rackContent.push('          </tr>');
			...
			rackContent.push('    </table></td>');
			rackContent.push('  </tr>');
			rackContent.push('</table> <br>');
		}
	}

	var rackContentString = rackContent.join("");
	document.getElementById("rackbody").innerHTML = rackContentString;
}
