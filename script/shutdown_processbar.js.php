...
function setImageWidth(currentTime)
{
	...
	var totalTime = 10000;            //假定恢复出厂设置需要用到的时间，此处为10秒
	...
	{
		document.getElementById("showText").innerHTML = "<?php echo $SHUTDOWN_TIP_A; ?>";
	...
	{
		document.getElementById("showText").innerHTML = "<?php echo $SHUTDOWN_TIP_B; ?>";
		
		imageId.width = totalLength;
		//alert("阵列已关闭!")
		window.opener = null; //关闭窗口时不弹出提示,网友说这只在IE以下的版本有效.
